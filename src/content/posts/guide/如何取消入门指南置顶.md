...
目前模板里的 Getting Started 文章位于 [src/content/posts/guide/入门指南.md](src/content/posts/guide/入门指南.md)，它的 Front-matter 里有这一行：
...
打开 [src/content/posts/guide/入门指南.md](src/content/posts/guide/入门指南.md)，把这一行：
...
2. 或者直接删除 [src/content/posts/guide/入门指南.md](src/content/posts/guide/入门指南.md)。
